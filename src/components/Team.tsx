...
const rankingData = [
  ...
  },
  {
    ...
    description: '最强之人',
    score: 100000000000,
    image: 'https://tr.rbxcdn.com/30DAY-AvatarHeadshot-AD65500CEA9897B706BD47F66325AB06-Png/150/150/AvatarHeadshot/Webp/noFilter',
    badges: ['脚本Dev',"最强之人"],
  },
  {
    rank: 3,
          ...
          {rankingData.map((member, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-center gap-2 text-slate-400 text-sm mb-3">
                ...
                <span>价格: <span className="text-yellow-400 font-bold">{member.score.toLocaleString()}</span></span>
              </div>
