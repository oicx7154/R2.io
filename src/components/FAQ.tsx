...
const faqs = [
  ...
  {
    q: '使用这些脚本会被封号吗？',
    a: '我们使用先进的反检测技术来最大限度地降低风险。但是，没有任何脚本是 100% 不会被检测的。我们建议使用小号以确保最大安全性。',
  },
  {
    q: '脚本多久更新一次？',
    a: '我们会在 Roblox 游戏更新后 24 小时内更新脚本。我们的团队全天候监控所有支持的游戏。',
  },
  {
    q: '如何使用这些脚本？',
    a: '只需从我们的网站复制脚本，打开你的执行器，将脚本粘贴到编辑器中，附加到 Roblox，然后点击执行。游戏内 GUI 界面会自动出现。',
  },
  {
    q: '我可以请求支持新游戏吗？',
    a: '当然可以！加入我们的 Discord 社区并提交游戏请求。我们会根据社区需求优先开发。',
  },
];
